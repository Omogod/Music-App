...
function welcomeEmail(firstname, token) {
                    ...
                    <tbody>
                      ...
                      <tr style="padding: 0px">
                        ...
                        >
                         ...
                         <a href="${config_1.default.FRONTEND_BASE_URL}/verify/?token=${token}">click here to verify</a> or copy this ${config_1.default.FRONTEND_BASE_URL}/verify/?token=${token} link and paste in your browser.
                         <br>
                          Thank you. <br /><br />
                        </td>
                      </tr>
